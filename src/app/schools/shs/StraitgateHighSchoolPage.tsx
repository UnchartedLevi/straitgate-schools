...
type StraitgateHighSchoolPageProps = {
  school?: School;
...
const headMessage =
  'At Straitgate High School, we are dedicated to providing a world-class education that empowers students to succeed in an ever-changing world. We strive to build a generation for God, delivering exceptional academic programs, modern resources, and outstanding teaching that prepares students for higher education and careers. Our curriculum fosters critical thinking, creativity, problem-solving, emotional intelligence, empathy, and social responsibility. Enrolling your child means academic excellence, personalized learning, an inclusive and supportive community, and rich extracurricular programs.';

const highSchoolImages = [
  {
    src: '/straitgate-high-school.jpg',
    alt: 'Straitgate High School campus and student life',
    label: 'Focused learning',
  },
  {
    src: '/straitgate-high-school1.jpg',
    alt: 'Straitgate High School campus and student life',
    label: 'Student community',
  },
  {
    src: '/straitgate-high-school2.jpg',
    alt: 'Straitgate High School campus and student life',
    label: 'Purposeful campus',
  },
  {
    src: '/straitgate-high-school3.jpg',
    alt: 'Straitgate High School campus and student life',
    label: 'Guided study',
  },
  {
    src: '/straitgate-high-school4.jpg',
    alt: 'Straitgate High School campus and student life',
    label: 'Student collaboration',
  },
  {
    src: '/straitgate-high-school5.jpg',
    alt: 'Straitgate High School campus and student life',
    label: 'Campus life',
  },
  {
    src: '/straitgate-high-school6.jpg',
    alt: 'Straitgate High School campus and student life',
    label: 'Academic instruction',
  },
  {
    src: '/straitgate-high-school7.jpg',
    alt: 'Straitgate High School campus and student life',
...
const videoStories = [
  ...
  },
  {
    ...
    platform: 'TikTok',
    href: 'https://www.tiktok.com/search?q=Straitgate%20High%20School',
  ...
  },
  {
    ...
    platform: 'YouTube',
    href: 'https://www.youtube.com/results?search_query=Straitgate+High+School+students',
    image: '/hero-classroom.webp',
  },
];
...
const facilities = [
  ...
  },
  {
    title: 'Game Court',
    description:
      'An open sports court where students build teamwork, fitness, and discipline through competitive play.',
...
export default function StraitgateHighSchoolPage({ school }: StraitgateHighSchoolPageProps) {
  const galleryTrackRef = useRef<HTMLDivElement>(null);
  const videoTrackRef = useRef<HTMLDivElement>(null);
  // High School apply CTAs always point to the Straitgate High School educare admission form.
  const applyHref = 'https://sghs.educare.school/admission-form';
  const address = school?.address || '14 Robert Street, Magodo, Ikosi Ketu, 105102, Lagos';
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col justify-end px-4 pb-16 pt-36 sm:px-6 lg:px-8 lg:pb-24">
          ...
          >
            ...
            <h1 className="font-serif text-5xl font-bold leading-[0.98] tracking-tight sm:text-6xl lg:text-8xl">
              Straitgate High <span className="text-primary">School</span>
            </h1>
            <p className="mt-7 max-w-2xl text-lg leading-8 text-white/78 sm:text-xl">
              A world-class education that empowers students to thrive, lead, and succeed in an ever-changing world.
            </p>
          ...
          >
            <div className="border border-white/15 bg-white/10 p-5 backdrop-blur">
              ...
              <p className="mt-2 text-3xl font-black">{school?.students_count ?? '650'}+</p>
            </div>
            ...
            <motion.div {...fadeUp}>
              <div className="max-w-2xl">
                ...
                <h2 className="text-xl italic leading-8 text-dark sm:text-2xl">
                  &quot;Every student is at the heart of our high school community.&quot;
                </h2>
              ...
              <div className="relative mx-auto w-full max-w-sm lg:ml-auto">
                ...
                <div className="relative overflow-hidden bg-light shadow-[0_28px_42px_-24px_rgba(0,0,0,0.55)]">
                  <div className="aspect-[4/5]">
                    <Image
                      src="/high-school-head.jpg"
                      alt="Portrait for Straitgate High School head of school message"
                      width={992}
                      height={1077}
      ...
      <section className="relative overflow-hidden bg-primary/5 py-20 sm:py-28">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              <p className={sectionEyebrowClass}>Why Straitgate High School</p>
              <h2 className={sectionTitleClass}>
                A high school environment shaped for focus, character, and confidence.
              </h2>
            ...
            <div className="relative min-h-[34rem] overflow-hidden rounded-[1.75rem] bg-light shadow-2xl shadow-black/10">
              <Image
                ...
                alt="Straitgate High School student learning in class"
                fill
      ...
      <section className="overflow-hidden bg-light text-dark">
        <div className="mx-auto grid max-w-7xl lg:grid-cols-2">
          <motion.div {...fadeUp} className="px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
            ...
            <h2 className={sectionTitleClass}>
              A high school experience built around focus, guidance, and growth.
            </h2>
      ...
      <section className="overflow-hidden bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="mx-auto max-w-3xl text-center">
            <p className={sectionEyebrowClass}>Life at high school</p>
            <h2 className={sectionTitleClass}>
          ...
          <div className="relative mt-12">
                    ...
                    <div className="relative aspect-[16/9] min-h-[22rem]">
                      ...
                      <div className="absolute left-5 top-5 flex items-center gap-3">
                        ...
                        <div className="text-white drop-shadow">
                          ...
                          <p className="text-xs font-semibold text-white/85">Straitgate High School</p>
                        </div>
                      </div>
            ...
            <div className="mt-8 flex items-center justify-center gap-6">
              <button
                type="button"
                aria-label="Previous high school video"
              ...
              <button
                type="button"
                aria-label="Next high school video"
                onClick={() => scrollVideo(1)}
                className="flex h-12 w-12 items-center justify-center rounded-full text-primary transition-colors hover:bg-primary hover:text-white"
              >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-xl font-semibold leading-8 text-dark/70 sm:text-2xl">
              Purpose-built spaces for science, creativity, sports, and reading culture.
            </h2>
          </motion.div>
            ...
            <div className="facilities-marquee flex w-max gap-6">
              {[...facilities, ...facilities].map((facility, index) => (
                ...
                >
                  <Image
                    src={facility.image}
                    alt={`${facility.title} at Straitgate High School`}
                    fill
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <motion.div {...fadeUp}>
            ...
            <h2 className="mt-4 text-xl font-semibold leading-8 text-white/90 sm:text-2xl">
              Ready to begin the Straitgate High School journey?
            </h2>
          ...
          <motion.div {...fadeUp} className="rounded-[2rem] bg-white p-7 text-dark shadow-2xl sm:p-9">
            ...
            <h3 className="mt-5 text-2xl font-bold">Apply to Straitgate High School</h3>
            <p className="mt-3 leading-7 text-gray-600">
              Complete the application form now and take the first step toward joining our high school community.
