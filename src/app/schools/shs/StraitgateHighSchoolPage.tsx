...
const facilities = [
  ...
  {
    title: 'Game Court',
    description: 'Team games, fitness, and discipline.',
  ...
  return (
    <>
      ...
      <SchoolGallery
        ...
        subtitle="A clear look at the classrooms, campus, and student community."
      />
      ...
      <SchoolPillarsSection pillars={pillars} label="Why choose Straitgate High School" />
      ...
      <FacilitiesStackSection
        ...
        subtitle="Purpose-built spaces for science, creativity, sports, and reading culture."
      />
