...
const headMessage =
  'Welcome to Straitgate Primary School Magodo, a premier institution dedicated to nurturing young minds with godly principles and a global perspective. We believe every child is a unique gift from God, deserving an education that fosters spiritual growth, academic excellence, and character development. Our curriculum blends academics with biblical values, empowering pupils to become innovative and compassionate leaders. Through co-curricular and extracurricular activities, our pupils grow in wisdom, stature, and favour with God and man. Our vision is building a generation of godly children.';

const galleryImages = [
  {
    src: '/straitgate-nursery-and-primary-school-magodo.jpg',
    alt: 'Straitgate Primary School Magodo campus and pupil life',
  ...
  {
    src: '/straitgate-nursery-and-primary-school-magodo3.jpg',
    alt: 'Straitgate Primary School Magodo campus and pupil life',
    label: 'Guided study',
  },
  {
    src: '/straitgate-nursery-and-primary-school-magodo4.jpg',
    alt: 'Straitgate Primary School Magodo campus and pupil life',
    label: 'Pupil collaboration',
  },
  {
  ...
  {
    src: '/straitgate-nursery-and-primary-school-magodo6.jpg',
    alt: 'Straitgate Primary School Magodo campus and pupil life',
    label: 'Academic instruction',
  },
  {
    src: '/straitgate-nursery-and-primary-school-magodo7.jpg',
    alt: 'Straitgate Primary School Magodo campus and pupil life',
  ...
  {
    src: '/straitgate-nursery-and-primary-school-magodo9.jpg',
    alt: 'Straitgate Primary School Magodo campus and pupil life',
    label: 'Active pupil life',
  },
  {
  ...
  {
    src: '/straitgate-nursery-and-primary-school-magodo11.jpg',
    alt: 'Straitgate Primary School Magodo campus and pupil life',
    label: 'Reading time',
  },
  {
...
const videoStories = [
  {
    ...
    platform: 'YouTube',
    href: 'https://www.youtube.com/results?search_query=Straitgate+Primary+School+Magodo',
    image: '/hero-classroom.webp',
  },
  {
    title: 'Pupil life highlights',
    platform: 'TikTok',
    href: 'https://www.tiktok.com/search?q=Straitgate%20Primary%20School%20Magodo',
  ...
  },
  {
    ...
    platform: 'YouTube',
    href: 'https://www.youtube.com/results?search_query=Straitgate+Primary+School+Magodo+pupils',
    image: '/hero-classroom.webp',
  },
];
...
const facilities = [
  {
    title: 'Science Lab',
    description:
      'A practical learning space where pupils observe, test, and connect science concepts to real experiments.',
  ...
  },
  {
    title: 'Playground',
    description:
      'An open play space where pupils build teamwork, fitness, and discipline through active games.',
...
export default function StraitgatePrimaryMagodoPage({ school }: StraitgatePrimaryMagodoPageProps) {
  ...
  const address = school?.address || 'Plot 86 Block 122 Alh. Basheer Shittu Street, Magodo, Lagos';
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col justify-end px-4 pb-16 pt-36 sm:px-6 lg:px-8 lg:pb-24">
          ...
          >
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-white/78 sm:text-xl">
              Nurturing young minds with godly principles and a global perspective.
            </p>
          ...
          >
            <div className="border border-white/15 bg-white/10 p-5 backdrop-blur">
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-white/50">Pupils</p>
              <p className="mt-2 text-3xl font-black">{school?.students_count ?? '1200'}+</p>
            </div>
              ...
              <div className="relative mx-auto w-full max-w-sm lg:ml-auto">
                ...
                <div className="relative overflow-hidden bg-light shadow-[0_28px_42px_-24px_rgba(0,0,0,0.55)]">
                  <div className="aspect-[4/5]">
                    <Image
                      src="/straitgate-nursery-and-primary-school-magodo-head.jpg"
                      alt="Portrait for Straitgate Primary School Magodo head of school message"
                      width={992}
                      height={1077}
      ...
      <section className="relative overflow-hidden bg-primary/5 py-20 sm:py-28">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              <p className={sectionEyebrowClass}>Why Straitgate Primary School Magodo</p>
            ...
            <div className="relative min-h-[34rem] overflow-hidden rounded-[1.75rem] bg-light shadow-2xl shadow-black/10">
              <Image
                ...
                alt="Straitgate Primary School Magodo pupil learning in class"
                fill
        ...
        <div className="mx-auto grid max-w-7xl lg:grid-cols-2">
          ...
          <div className="relative min-h-[520px] overflow-hidden bg-white lg:min-h-full">
            <Image
              ...
              alt="Straitgate Primary School Magodo classroom learning"
              fill
                    ...
                    <div className="relative aspect-[16/9] min-h-[22rem]">
                      ...
                      <div className="absolute left-5 top-5 flex items-center gap-3">
                        ...
                        <div className="text-white drop-shadow">
                          ...
                          <p className="text-xs font-semibold text-white/85">Straitgate Primary School Magodo</p>
                        </div>
                      </div>
            ...
            <div className="facilities-marquee flex w-max gap-6">
              {[...facilities, ...facilities].map((facility, index) => (
                ...
                >
                  <Image
                    src={facility.image}
                    alt={`${facility.title} at Straitgate Primary School Magodo`}
                    fill
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <motion.div {...fadeUp}>
            ...
            <h2 className="mt-4 text-xl font-semibold leading-8 text-white/90 sm:text-2xl">
              Ready to begin the Straitgate Primary School Magodo journey?
            </h2>
          ...
          <motion.div {...fadeUp} className="rounded-[2rem] bg-white p-7 text-dark shadow-2xl sm:p-9">
            ...
            <h3 className="mt-5 text-2xl font-bold">Apply to Straitgate Primary School Magodo</h3>
