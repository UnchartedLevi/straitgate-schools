...
const facilities = [
  {
    title: 'Science Lab',
    description: 'Simple science and discovery space.',
    image: '/sgpics/home-stem-club.jpg',
  },
  {
    title: 'ICT Lab',
    description: 'Digital skills and computer learning.',
    image: '/sgpics/home-stem-club.jpg',
  },
  {
    title: 'Library',
    ...
    <>
      <section className="relative min-h-screen overflow-hidden bg-[#080808] text-white">
        <div
          ...
          style={{ backgroundImage: "url('/sgpics/magodo-hero.jpg')" }}
          aria-hidden="true"
        />
